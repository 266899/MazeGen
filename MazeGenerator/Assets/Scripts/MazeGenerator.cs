...
public class MazeGenerator : MonoBehaviour
{
    ...
    private float wallLength = 1f; // Default wall length. Shouldn't change.
    private float floorLength = 1f; // Default floor length. Shouldn't change.
    ...
    private void GenerateWalls()
    {
        ...
        // Using x and z values from the input fields
        xSize = PlayerPrefs.GetInt("Length");
        zSize = PlayerPrefs.GetInt("Width");
        ...
        for (int i = 0; i < zSize; i++)
        {
            ...
            {
                targetPosition = new Vector3((j * wallLength) - wallLength/2, 0 , + (i * wallLength) - wallLength/2);  // Calculating next position of the wall
        ...
        for (int i = 0; i <= zSize; i++)
        {
            for (int j = 0; j < xSize; j++)
            {
                targetPosition = new Vector3((j* wallLength), 0, (i * wallLength) - wallLength); // Calculating next position of the wall
